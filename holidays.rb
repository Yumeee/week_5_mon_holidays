...
baymax = Cohort.new(Date.new(2018,05,16))
puts baymax

puts baymax.last_day
puts baymax.class_days

canadaday= Date.new(2018,07,01)
puts baymax.double_check_holiday(canadaday)

puts baymax.weeks_of_cohort

puts baymax.coffee_code_week?(Date.new(2018,05,20))
